...
input. We assembled 566 protein chains from PDB complexes released
after AlphaFold2's training cutoff, filtered to under
30\% sequence identity to PeSTo's own training,
...
residue range. Across 554 chains with defined metrics, PeSTo's
...
chains of at least 40 modeled residues. This search returned
...
696 representatives below this threshold.

For each primary-set representative, both the experimental (PDB) structure and
the corresponding AlphaFold DB model were downloaded; 609
...
Table~\ref{tab:regression}; $n=$95,117 residues, 566 chain
