...
\caption{A representative chain (no headless 3D molecular renderer could be installed in this environment, so this is a matplotlib rendering of C$\alpha$ positions colored by value, not a rendered surface -- see Methods discussion in the accompanying repository documentation).
